      ...
      <div className="w-full max-w-[640px] animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <div className="bg-white rounded-xl shadow-md border border-[#c3c6d7] overflow-hidden">
          ...
          <form onSubmit={handleFormSubmit} className="p-8 space-y-6" id="add-landmark-form">
            ...
            {/* Visual Geospatial Preview Context Placeholder Image */}
            <div className="relative h-44 rounded-xl overflow-hidden border border-[#c3c6d7] bg-[#eef4fe] group select-none">
              <img
                className="w-full h-full object-cover opacity-60 mix-blend-multiply transition-transform duration-700 group-hover:scale-102 pointer-events-none"
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuDBR9H88jyyA8hSQq-ViSyKqah8YodVO6viJxqcB3ceDESfp49rn4dwJFE30fTwY8T_Sa1MChMB5HbbZ4iIV89G3y60sxTPxQccqAKwd-FCujBtuHwOEA1jC6WVJ08VwF1KulUCA_xT5tfuikP5E5dnDSDUIn3jdFGA-JY5ywEQ4vhgOJEp3QFHlLXYxWLmDZl6Uon-6j6DDDtZVpcqPcHxxuUU9r47lfQcc1Ned7kEQkcJR8wS--Ii1jbTYbpJjXZVVljm-BGJJ7_b"
                alt="Decorative grid representation placeholder"
              />
